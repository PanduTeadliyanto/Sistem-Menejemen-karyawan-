...
<div class="container">
    ...
    <div class="row mt-5">
        ...
        <div class="col-4">
            <div class="card shadow " style="width: 18rem;">
                <ul class="list-group list-group-flush">
                    <li class="list-group-item text-center">Karyawna</li>
                    <li class="list-group-item">Total Karyawan : <?php echo mysqli_num_rows($total_emp); ?></li>
                    <li class="list-group-item text-center"><a href="manage-employee.php"> <b>Lihat Semua Karyawan</b></a></li>
                </ul>
            </div>
        </div>
        <div class="col-4">
            <div class="card shadow " style="width: 18rem;">
                <ul class="list-group list-group-flush">
                    <li class="list-group-item text-center">Karyawan Cuti</li>
                    <li class="list-group-item">Hari Ini :  <?php echo $today_leave; ?>  </li>
                    <li class="list-group-item">Besok :  <?php echo $tomarrow_leave; ?> </li>
                </ul>
            </div>
        </div>
    </div>
