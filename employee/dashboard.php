...
<div class="container">
    ...
    <div class="row mt-5">
        <div class="col-4">
            <div class="card shadow " style="width: 18rem;">
                <ul class="list-group list-group-flush">
                    <li class="list-group-item text-center"> <b>Tinggalkan Status</b> </li>
        ...
        <div class="col-4">
            <div class="card shadow " style="width: 18rem;">
                <ul class="list-group list-group-flush">
                    <li class="list-group-item text-center"> <b>Karyawan</b>  </li>
                    <li class="list-group-item">Total Karyawan : <?php echo mysqli_num_rows($total_emp); ?></li>
                    <li class="list-group-item text-center"><a href="view-employee.php"> <b>Lihat semua karyawan</b></a></li>
                </ul>
            </div>
        </div>
    </div>
